...
## 如果你是 Linux 用户
* 推荐使用 [⏬ Ubuntu LTS version，点此可下载](https://ubuntu.com/download/desktop) Currently: Ubuntu 18.04.2 LTS
* 在桌面单击右键，再单击打开终端
...
1. 使用 Linux 虚拟机
	* [⏬ 开源虚拟机软件：VirtualBox，点此可下载](https://www.virtualbox.org/wiki/Downloads)
	* [⏬ Ubuntu 18.04.2 LTS（Long Term Support）长期支持版本，点此下载](https://ubuntu.com/download/desktop)

2. *或者* 学习如何使用 Dev-Cpp，具体请观看慕课：[▶️ 浙江大学 翁恺老师 程序设计入门——C 语言，点此可加入课程学习](http://www.icourse163.org/course/ZJU-199001?tid=235001) 学习
...
⏰ **提醒**：以下内容中，数字序号介绍的是命令；显示为小圆圈的项目符号是期望读者在自己的终端中执行的内容
